...
export const TITLES: readonly TitleDef[] = [
  { id: "heart_already_home", name: "마음만 이미 집에 있음", hint: "집까지 300번", pose: "lie", priority: 1 },
  { id: "last_hour_sprinter", name: "퇴근 1시간 전 폭주형", hint: "17시 이후 90번", pose: "run", priority: 2 },
  ...
  { id: "bearable_day", name: "오늘은 버틸 만했던 자", hint: "30번 미만인 날", pose: "stand", priority: 5 },
];
