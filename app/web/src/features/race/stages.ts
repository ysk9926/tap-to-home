...
/**
 * 집까지 5000번. 간격이 뒤로 갈수록 벌어져(750→850→900→1150→1350) 막판이 제일 길다.
...
export const STAGES: readonly Stage[] = [
  ...
  { key: "elevator", label: "엘리베이터", short: "엘베", threshold: 750, pose: "stand" },
  { key: "lobby", label: "로비", short: "로비", threshold: 1600, pose: "stand" },
  { key: "crosswalk", label: "횡단보도", short: "횡단보도", threshold: 2500, pose: "stand" },
  { key: "subway", label: "지하철", short: "지하철", threshold: 3650, pose: "subway" },
  { key: "home", label: "집", short: "집", threshold: 5000, pose: "lie" },
];
